...
class Switch extends Component {
  ...
  _layoutThumb(checked, thumbRadius, trackLength, trackSize, rippleRadius) {
    const trackRadii = trackSize / 2;
    const thumbRadii = thumbRadius;
    const rippleRadii = rippleRadius  == undefined ? trackLength - trackSize : rippleRadius;
